...
uses
  Classes, SysUtils,ujson, lpcompiler, lptypes, ulpClassHelper;
type
...
procedure TJSONArray_create(const Params: PParamArray);cdecl;
begin
  PJSONArray(Params^[0])^ := TJSONArray.Create();
end;

//constructor create (s : string);  overload;
procedure TJSONArray_createExExEx(const Params: PParamArray);cdecl;
begin
  PJSONArray(Params^[0])^ := TJSONArray.Create(PlpString(Params^[1])^);
end;

//function get (index : integer) : TZAbstractObject;
procedure TJSONArray_get(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PZAbstractObject(Result)^ := PJSONArray(Params^[0])^.get(Pinteger(Params^[1])^);
end;

//function getBoolean (index : integer) : boolean;
procedure TJSONArray_getBoolean(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PJSONArray(Params^[0])^.getBoolean(Pinteger(Params^[1])^);
end;

//function getDouble (index : integer) : double;
procedure TJSONArray_getDouble(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pdouble(Result)^ := PJSONArray(Params^[0])^.getDouble(Pinteger(Params^[1])^);
end;

//function getInt (index : integer): integer;
procedure TJSONArray_getInt(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PJSONArray(Params^[0])^.getInt(Pinteger(Params^[1])^);
end;

//function getJSONArray (index : integer) : TJSONArray;
procedure TJSONArray_getJSONArray(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PJSONArray(Result)^ := PJSONArray(Params^[0])^.getJSONArray(Pinteger(Params^[1])^);
end;

//function getJSONObject (index : integer) : TJSONObject;
procedure TJSONArray_getJSONObject(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PJSONObject(Result)^ := PJSONArray(Params^[0])^.getJSONObject(Pinteger(Params^[1])^);
end;

//function getString (index : integer) : string;
procedure TJSONArray_getString(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PlpString(Result)^ := PJSONArray(Params^[0])^.getString(Pinteger(Params^[1])^);
end;

//function isNull (index : integer): boolean;
procedure TJSONArray_isNull(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PJSONArray(Params^[0])^.isNull(Pinteger(Params^[1])^);
end;

//function join (separator : string) : string;
procedure TJSONArray_join(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PlpString(Result)^ := PJSONArray(Params^[0])^.join(PlpString(Params^[1])^);
end;

//function length : integer;
procedure TJSONArray_length(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PJSONArray(Params^[0])^.length();
end;

//function opt (index : integer) : TZAbstractObject;
procedure TJSONArray_opt(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PZAbstractObject(Result)^ := PJSONArray(Params^[0])^.opt(Pinteger(Params^[1])^);
end;

//function optBoolean ( index : integer) : boolean; overload;
procedure TJSONArray_optBoolean(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONArray_optBooleanEx(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONArray_optDouble(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONArray_optDoubleEx(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONArray_optInt(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONArray_optIntEx(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONArray_optJSONArray(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONArray_optJSONObject(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PJSONObject(Result)^ := PJSONArray(Params^[0])^.optJSONObject(Pinteger(Params^[1])^);
end;

//function optString (index : integer) : string; overload;
procedure TJSONArray_optString(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONArray_optStringEx(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONArray_putExExExExExEx(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONArray_putExExExExExExEx(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONArray_putExExExExExExExEx(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONArray_putExExExExExExExExEx(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONArray_toJSONObject(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PJSONObject(Result)^ := PJSONArray(Params^[0])^.toJSONObject(PJSONArray(Params^[1])^);
end;

//function toString : string; overload; override;
procedure TJSONArray_toString(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PLpstring(Result)^ := PJSONArray(Params^[0])^.toString();
end;

//function toString (indentFactor : integer) : string; overload;
procedure TJSONArray_toStringEx(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONArray_toStringExEx(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
//constructor Create();
procedure TJSONArray_Init(const Params: PParamArray);cdecl;
begin
  PJSONArray(Params^[0])^ := TJSONArray.Create();
end;

//procedure Free();
procedure TJSONArray_Free(const Params: PParamArray);cdecl;
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('function TJSONArray.put( value : double ): TJSONArray; constref; overload;', @TJSONArray_putEx);
    addGlobalFunc('function TJSONArray.put( value : integer): TJSONArray; constref; overload;', @TJSONArray_putExEx);
    addGlobalFunc('function TJSONArray.put( value : pointer): TJSONArray; constref; overload;', @TJSONArray_putExExEx);
    addGlobalFunc('function TJSONArray.put( value: string): TJSONArray; constref; overload;', @TJSONArray_putExExExEx);
    addGlobalFunc('function TJSONArray.put( index : integer ; value : boolean): TJSONArray; constref; overload;', @TJSONArray_putExExExExEx);
    addGlobalFunc('function TJSONArray.put( index : integer ; value : double): TJSONArray; constref; overload;', @TJSONArray_putExExExExExEx);
    addGlobalFunc('function TJSONArray.put( index : integer ; value : integer): TJSONArray; constref; overload;', @TJSONArray_putExExExExExExEx);
    addGlobalFunc('function TJSONArray.put( index : integer ; value : pointer): TJSONArray; constref; overload;', @TJSONArray_putExExExExExExExEx);
...
//constructor create;  overload;
procedure TJSONObject_create(const Params: PParamArray);cdecl;
begin
  PJSONObject(Params^[0])^ := TJSONObject.Create();
end;

//constructor create (s : string); overload;
procedure TJSONObject_createExExExEx(const Params: PParamArray);cdecl;
begin
  PJSONObject(Params^[0])^ := TJSONObject.Create(PlpString(Params^[1])^);
end;

//procedure clean;
procedure TJSONObject_clean(const Params: PParamArray);cdecl;
begin
  PJSONObject(Params^[0])^.clean();
end;

//function clone : pointer; override;
procedure TJSONObject_clone(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PZAbstractObject(Result)^ := PJSONObject(Params^[0])^.clone();
end;

//function accumulate (key : string; value : pointer): TJSONObject;
procedure TJSONObject_accumulate(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONObject_get(const Params: PParamArray; const Result: Pointer);cdecl;
begin
 PZAbstractObject(Result)^ := PJSONObject(Params^[0])^.get(PlpString(Params^[1])^);
end;

//function getBoolean (key : string): boolean;
procedure TJSONObject_getBoolean(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PJSONObject(Params^[0])^.getBoolean(PlpString(Params^[1])^);
end;

//function getDouble (key : string): double;
procedure TJSONObject_getDouble(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pdouble(Result)^ := PJSONObject(Params^[0])^.getDouble(PlpString(Params^[1])^);
end;

//function getInt (key : string): integer;
procedure TJSONObject_getInt(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PJSONObject(Params^[0])^.getInt(PlpString(Params^[1])^);
end;

//function getJSONArray (key : string) :TJSONArray;
procedure TJSONObject_getJSONArray(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PJSONArray(Result)^ := PJSONObject(Params^[0])^.getJSONArray(PlpString(Params^[1])^);
end;

//function getJSONObject (key : string) : TJSONObject;
procedure TJSONObject_getJSONObject(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PJSONObject(Result)^ := PJSONObject(Params^[0])^.getJSONObject(PlpString(Params^[1])^);
end;

//function getString (key : string): string;
procedure TJSONObject_getString(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PlpString(Result)^ := PJSONObject(Params^[0])^.getString(PlpString(Params^[1])^);
end;

//function has (key : string) : boolean;
procedure TJSONObject_has(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PJSONObject(Params^[0])^.has(PlpString(Params^[1])^);
end;

//function isNull (key : string) : boolean;
procedure TJSONObject_isNull(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PJSONObject(Params^[0])^.isNull(PlpString(Params^[1])^);
end;

//function keys : TStringList ;
procedure TJSONObject_keys(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PStringList(Result)^ := PJSONObject(Params^[0])^.keys();
end;

//function length : integer;
procedure TJSONObject_length(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PJSONObject(Params^[0])^.length();
end;

//function names : TJSONArray;
procedure TJSONObject_names(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONObject_opt(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PZabstractObject(Result)^ := PJSONObject(Params^[0])^.opt(PlpString(Params^[1])^);
end;

//function optBoolean (key : string): boolean; overload;
procedure TJSONObject_optBoolean(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONObject_optBooleanEx(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONObject_optDouble(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONObject_optDoubleEx(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONObject_optInt(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONObject_optIntEx(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONObject_optString(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONObject_optStringEx(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONObject_optJSONArray(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONObject_optJSONObject(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONObject_put(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONObject_putEx(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONObject_putExEx(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONObject_putExExEx(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONObject_putExExExEx(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONObject_putOpt(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TJSONObject_remove(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PZAbstractObject(Result)^ := PJSONObject(Params^[0])^.remove(PlpString(Params^[1])^);
end;

//procedure assignTo(json: TJSONObject);
procedure TJSONObject_assignTo(const Params: PParamArray);cdecl;
begin
  PJSONObject(Params^[0])^.assignTo(PJSONObject(Params^[1])^);
end;

//function toJSONArray (names : TJSONArray) : TJSONArray;
procedure TJSONObject_toJSONArray(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PJSONArray(Result)^ := PJSONObject(Params^[0])^.toJSONArray(PJSONArray(Params^[1])^);
end;

//function toString (): string ;  overload; override;
procedure TJSONObject_toString(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PlPstring (Result)^ := PJSONObject(Params^[0])^.toString();
end;

//function toString (indentFactor : integer): string; overload;
procedure TJSONObject_toStringEx(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PlpString(Result)^ := PJSONObject(Params^[0])^.toString(Pinteger(Params^[1])^);
end;

//function toString (indentFactor, indent : integer): string; overload;
procedure TJSONObject_toStringExEx(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PlpString(Result)^ := PJSONObject(Params^[0])^.toString(Pinteger(Params^[1])^, Pinteger(Params^[2])^);
end;

//constructor Create();
procedure TJSONObject_Init(const Params: PParamArray);cdecl;
begin
  PJSONObject(Params^[0])^ := TJSONObject.Create();
end;

//procedure Free();
procedure TJSONObject_Free(const Params: PParamArray);cdecl;
begin
