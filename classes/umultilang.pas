...
uses
  Classes, SysUtils, Controls, Forms,StdCtrls, gvector,
  gutil,{I like generics:)}XMLRead, XMLWrite, Dom, TypInfo;
const
  LangPath = 'languages\';
type
  ...
  public
    ...
    // property HaveHint: boolean read FHaveHint write FHaveHint;
...
begin
  ...
  CreationDate := StrToInt64(aParentNode.Attributes.GetNamedItem('CreationDate').NodeValue);
  ModifiedDate := StrToInt64(aParentNode.Attributes.GetNamedItem('ModifiedDate').NodeValue);
end;
...
begin
  ...
  ComponentCaption := aParentNode.Attributes.GetNamedItem(
    'Caption').NodeValue;
