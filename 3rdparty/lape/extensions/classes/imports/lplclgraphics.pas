...
uses
  Classes, SysUtils,Graphics, lpcompiler, lptypes, ulpClassHelper;
...
procedure TGraphicsObject_OnChanging_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TGraphicsObject_OnChanging_Write(const Params: PParamArray);cdecl;
begin
...
procedure TGraphicsObject_OnChange_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PNotifyEvent(Result)^ := PGraphicsObject(Params^[0])^.OnChange;
end;

//Write: property OnChange: TNotifyEvent read OnChange write OnChange;
procedure TGraphicsObject_OnChange_Write(const Params: PParamArray);cdecl;
begin
  PGraphicsObject(Params^[0])^.OnChange := PNotifyEvent(Params^[1])^;
end;

//constructor Create();
procedure TGraphicsObject_Init(const Params: PParamArray);cdecl;
begin
  PGraphicsObject(Params^[0])^ := TGraphicsObject.Create();
end;

//procedure Free();
procedure TGraphicsObject_Free(const Params: PParamArray);cdecl;
begin
...
procedure TFont_Quality_Write(const Params: PParamArray);cdecl;
begin
  PFont(Params^[0])^.Quality := PFontQuality(Params^[1])^;
end;

//procedure Free();
procedure TFont_Free(const Params: PParamArray);cdecl;
begin
  PFont(Params^[0])^.Free();
end;
...
begin
  ...
  begin
    ...
    addGlobalFunc('function TFont.IsDefault(): boolean; constref;', @TFont_IsDefault);
    addGlobalFunc('function TFont.IsEqual(AFont: TFont): boolean; constref;', @TFont_IsEqual);
    addClassVar('TFont', 'IsMonoSpace', 'boolean', @TFont_IsMonoSpace_Read);
    addGlobalFunc('procedure TFont.SetDefault(); constref;', @TFont_SetDefault);
...
{TBrush}
//procedure Assign(Source: TPersistent);
procedure TBrush_Assign(const Params: PParamArray);cdecl;
begin
  PBrush(Params^[0])^.Assign(PPersistent(Params^[1])^);
end;

//constructor Create;
procedure TBrush_Init(const Params: PParamArray);cdecl;
begin
  PBrush(Params^[0])^ := TBrush.Create();
end;

//Read: property Color: Integer read Color write Color;
procedure TBrush_Color_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PBrush(Params^[0])^.Color;
end;

//Write: property Color: Integer read Color write Color;
procedure TBrush_Color_Write(const Params: PParamArray);cdecl;
begin
  PBrush(Params^[0])^.Color := PInteger(Params^[1])^;
end;

//Read: property Style:TBrushStyle read Style write Style;
procedure TBrush_Style_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBrushStyle(Result)^ := PBrush(Params^[0])^.Style;
end;

//Write: property Style:TBrushStyle read Style write Style;
procedure TBrush_Style_Write(const Params: PParamArray);cdecl;
begin
  PBrush(Params^[0])^.Style := PBrushStyle(Params^[1])^;
end;

//procedure Free();
procedure TBrush_Free(const Params: PParamArray);cdecl;
begin
...
{TCanvas}
//procedure Lock;
procedure TCanvas_Lock(const Params: PParamArray);cdecl;
begin
  PCanvas(Params^[0])^.Lock();
end;

//function TryLock: Boolean;
procedure TCanvas_TryLock(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PCanvas(Params^[0])^.TryLock();
end;

//procedure Unlock; ;
procedure TCanvas_Unlock(const Params: PParamArray);cdecl;
begin
  PCanvas(Params^[0])^.Unlock();
end;

//procedure Refresh;
procedure TCanvas_Refresh(const Params: PParamArray);cdecl;
begin
  PCanvas(Params^[0])^.Refresh();
end;

//procedure Changing;
procedure TCanvas_Changing(const Params: PParamArray);cdecl;
begin
  PCanvas(Params^[0])^.Changing();
end;

//procedure Changed;
procedure TCanvas_Changed(const Params: PParamArray);cdecl;
begin
  PCanvas(Params^[0])^.Changed();
end;

//procedure SaveHandleState;
procedure TCanvas_SaveHandleState(const Params: PParamArray);cdecl;
begin
  PCanvas(Params^[0])^.SaveHandleState();
end;

//procedure RestoreHandleState;
procedure TCanvas_RestoreHandleState(const Params: PParamArray);cdecl;
begin
  PCanvas(Params^[0])^.RestoreHandleState();
end;

//procedure Arc(ALeft, ATop, ARight, ABottom, SX, SY, EX, EY: Integer);
procedure TCanvas_Arc(const Params: PParamArray);cdecl;
begin
...
procedure TCanvas_Chord(const Params: PParamArray);cdecl;
begin
...
procedure TCanvas_FloodFill(const Params: PParamArray);cdecl;
begin
...
procedure TCanvas_RadialPie(const Params: PParamArray);cdecl;
begin
...
procedure TCanvas_Pie(const Params: PParamArray);cdecl;
begin
...
procedure TCanvas_PolyBezier(const Params: PParamArray);cdecl;
begin
...
procedure TCanvas_PolyBezierEx(const Params: PParamArray);cdecl;
begin
...
procedure TCanvas_Polygon(const Params: PParamArray);cdecl;
begin
...
procedure TCanvas_PolylineEx(const Params: PParamArray);cdecl;
begin
  PCanvas(Params^[0])^.Polyline(PPPoint(Params^[1])^, PInteger(Params^[2])^);
end;

//procedure Polyline( Points: TPointArray);
procedure TCanvas_PolylineExEx(const Params: PParamArray);cdecl;
begin
  PCanvas(Params^[0])^.Polyline(PPointArray(Params^[1])^);
end;

//procedure Rectangle(X1,Y1,X2,Y2: Integer);
procedure TCanvas_Rectangle(const Params: PParamArray);cdecl;
begin
...
procedure TCanvas_RectangleEx(const Params: PParamArray);cdecl;
begin
  PCanvas(Params^[0])^.Rectangle(PRect(Params^[1])^);
end;

//procedure RoundRect(X1, Y1, X2, Y2: Integer; RX,RY: Integer);
procedure TCanvas_RoundRect(const Params: PParamArray);cdecl;
begin
...
procedure TCanvas_RoundRectEx(const Params: PParamArray);cdecl;
begin
  PCanvas(Params^[0])^.RoundRect(PRect(Params^[1])^, PInteger(Params^[2])^, PInteger(Params^[3])^);
end;

//procedure TextOut(X,Y: Integer;  Text: String);
procedure TCanvas_TextOut(const Params: PParamArray);cdecl;
begin
...
procedure TCanvas_Get_Pixel(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PColor(Result)^ := PCanvas(Params^[0])^.Pixels[PInteger(Params^[1])^, PInteger(Params^[2])^];
end;

procedure TCanvas_Set_Pixel(const Params: PParamArray);cdecl;
begin
  PCanvas(Params^[0])^.Pixels[PInteger(Params^[1])^, PInteger(Params^[2])^] := PColor(Params^[3])^;
end;

procedure TCanvas_Set_Pixels(const Params: PParamArray);cdecl;
var
  TPA: TPointArray;
  i, h: integer;
  Col: TColor;
...
procedure TCanvas_SetPixels(const Params: PParamArray);cdecl;
var
  TPA: TPointArray;
  Cols: TIntegerArray;
  i, h: integer;
...
procedure TCanvas_Draw(const Params: PParamArray);cdecl;
begin
  PCanvas(Params^[0])^.Draw(PInteger(Params^[1])^, PInteger(Params^[2])^, PGraphic(Params^[3])^);
end;

//constructor Create();
procedure TCanvas_Init(const Params: PParamArray);cdecl;
begin
  PCanvas(Params^[0])^ := TCanvas.Create();
end;

//procedure Free();
procedure TCanvas_Free(const Params: PParamArray);cdecl;
begin
  PCanvas(Params^[0])^.Free();
end;

procedure TCanvas_Clear(const Params: PParamArray);cdecl;
begin
  PCanvas(Params^[0])^.Clear();
end;

procedure TCanvas_Frame(const Params: PParamArray);cdecl;
begin
  PCanvas(Params^[0])^.Frame(PInteger(Params^[1])^, PInteger(Params^[2])^, PInteger(Params^[3])^, PInteger(Params^[4])^);
end;

procedure TCanvas_Frame3D(const Params: PParamArray);cdecl;
begin
  PCanvas(Params^[0])^.Frame3D(PRect(Params^[1])^, PInteger(Params^[2])^, PInteger(Params^[3])^, PInteger(Params^[4])^);
end;

procedure TCanvas_LineTo(const Params: PParamArray);cdecl;
begin
  PCanvas(Params^[0])^.LineTo(PInteger(Params^[1])^, PInteger(Params^[2])^);
end;

procedure TCanvas_MoveTo(const Params: PParamArray);cdecl;
begin
  PCanvas(Params^[0])^.MoveTo(PInteger(Params^[1])^, PInteger(Params^[2])^);
end;

procedure TCanvas_AntialiasingMode_Set(const Params: PParamArray);cdecl;
begin
  PCanvas(Params^[0])^.AntialiasingMode := PAntialiasingMode(Params^[1])^;
end;

procedure TCanvas_AntialiasingMode_Get(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure TCanvas.Lock(); constref;', @TCanvas_Lock);
    addGlobalFunc('function TCanvas.TryLock(): Boolean; constref;', @TCanvas_TryLock);
    addGlobalFunc('procedure TCanvas.Unlock(); constref;', @TCanvas_Unlock);
    addGlobalFunc('procedure TCanvas.Refresh(); constref;', @TCanvas_Refresh);
    addGlobalFunc('procedure TCanvas.Changing(); constref;', @TCanvas_Changing);
    addGlobalFunc('procedure TCanvas.Changed(); constref;', @TCanvas_Changed);
    addGlobalFunc('procedure TCanvas.SaveHandleState(); constref;', @TCanvas_SaveHandleState);
    addGlobalFunc('procedure TCanvas.RestoreHandleState(); constref;', @TCanvas_RestoreHandleState);
    addGlobalFunc('procedure TCanvas.Arc(ALeft, ATop, ARight, ABottom, SX, SY, EX, EY: Integer); constref;', @TCanvas_Arc);
    addGlobalFunc('procedure TCanvas.Chord(x1, y1, x2, y2, SX, SY, EX, EY: Integer); constref;', @TCanvas_Chord);
    addGlobalFunc('procedure TCanvas.CopyRect(Dest: TRect; SrcCanvas: TCanvas;Source: TRect); constref;', @TCanvas_CopyRect);
    addGlobalFunc('procedure TCanvas.Draw(X,Y: Integer; SrcGraphic: TGraphic); constref;', @TCanvas_Draw);
    addGlobalFunc('procedure TCanvas.DrawFocusRect(ARect: TRect); constref;', @TCanvas_DrawFocusRect);
    addGlobalFunc('procedure TCanvas.Ellipse(x1, y1, x2, y2: Integer); constref;', @TCanvas_Ellipse);
    addGlobalFunc('procedure TCanvas.FillRect(X1,Y1,X2,Y2: Integer); constref;', @TCanvas_FillRect);
    addGlobalFunc('procedure TCanvas.FloodFill(X, Y: Integer; FillColor: TColor;FillStyle: TFillStyle); constref;', @TCanvas_FloodFill);
    addGlobalFunc('procedure TCanvas.RadialPie(x1, y1, x2, y2, StartAngle16Deg, Angle16DegLength: Integer); constref;', @TCanvas_RadialPie);
    addGlobalFunc('procedure TCanvas.Pie(EllipseX1,EllipseY1,EllipseX2,EllipseY2, StartX,StartY,EndX,EndY: Integer); constref;', @TCanvas_Pie);
    addGlobalFunc('procedure TCanvas.PolyBezier(Points: PPoint; NumPts: Integer; Filled: boolean;Continuous: boolean); constref;', @TCanvas_PolyBezier);
    addGlobalFunc('procedure TCanvas.PolyBezier( Points: TPointArray;Filled: boolean; Continuous: boolean); constref; overload;', @TCanvas_PolyBezierEx);
    addGlobalFunc('procedure TCanvas.Polygon( Points: TPointArray;Winding: Boolean;StartIndex: Integer; NumPts: Integer); constref;', @TCanvas_Polygon);
    addGlobalFunc('procedure TCanvas.Polygon(Points: PPoint; NumPts: Integer;Winding: boolean); constref; overload;', @TCanvas_PolygonEx);
    addGlobalFunc('procedure TCanvas.Polygon( Points: TPointArray); constref; overload;', @TCanvas_PolygonExEx);
    addGlobalFunc('procedure TCanvas.Polyline( Points: TPointArray;StartIndex: Integer;NumPts: Integer); constref;', @TCanvas_Polyline);
    addGlobalFunc('procedure TCanvas.Polyline(Points: PPoint; NumPts: Integer); constref; overload;', @TCanvas_PolylineEx);
    addGlobalFunc('procedure TCanvas.Polyline( Points: TPointArray); constref; overload;', @TCanvas_PolylineExEx);
    addGlobalFunc('procedure TCanvas.Rectangle(X1,Y1,X2,Y2: Integer); constref;', @TCanvas_Rectangle);
    addGlobalFunc('procedure TCanvas.Rectangle( ARect: TRect); constref; overload;', @TCanvas_RectangleEx);
    addGlobalFunc('procedure TCanvas.RoundRect(X1, Y1, X2, Y2: Integer; RX,RY: Integer); constref;', @TCanvas_RoundRect);
    addGlobalFunc('procedure TCanvas.RoundRect( Rect: TRect; RX,RY: Integer); constref; overload;', @TCanvas_RoundRectEx);
    addGlobalFunc('procedure TCanvas.TextOut(X,Y: Integer;  Text: String); constref;', @TCanvas_TextOut);
    addGlobalFunc('procedure TCanvas.TextRect( ARect: TRect; X, Y: integer;  Text: string); constref;', @TCanvas_TextRect);
    addGlobalFunc('function TCanvas.TextHeight( Text: string): Integer; constref;', @TCanvas_TextHeight);
    addGlobalFunc('function TCanvas.TextWidth( Text: string): Integer; constref;', @TCanvas_TextWidth);
    addGlobalFunc('function TCanvas.HandleAllocated(): Boolean; constref;', @TCanvas_HandleAllocated);
    addGlobalFunc('function TCanvas.GetPixel(x, y: integer): TColor; constref;', @TCanvas_Get_Pixel);
    addGlobalFunc('procedure TCanvas.SetPixel(x, y: integer; Colour: TColor); constref;', @TCanvas_Set_Pixel);
    addGlobalFunc('procedure TCanvas.SetPixels(TPA: TPointArray; Colour: TColor); constref;', @TCanvas_Set_Pixels);
    addGlobalFunc('procedure TCanvas.SetPixels(TPA: TPointArray; Cols: TIntegerArray); constref; overload;', @TCanvas_SetPixels);
    addGlobalFunc('function TCanvas.GetPixels(const TPA: TPointArray): TIntegerArray; constref;', @TCanvas_GetPixels);
    addGlobalFunc('procedure TCanvas.Clear(); constref;', @TCanvas_Clear);
    addGlobalFunc('procedure TCanvas.MoveTo(x, y: Integer); constref;', @TCanvas_MoveTo);
    addGlobalFunc('procedure TCanvas.LineTo(x, y: Integer); constref;', @TCanvas_LineTo);
    addGlobalFunc('procedure TCanvas.Frame3D(var ARect: TRect; TopColor, BottomColor: TColor; const FrameWidth: integer); constref;', @TCanvas_Frame3D);
    addGlobalFunc('procedure TCanvas.Frame(X1, Y1, X2, Y2: Integer); constref;', @TCanvas_Frame);
...
procedure TGraphic_Assign(const Params: PParamArray);cdecl;
begin
  PGraphic(Params^[0])^.Assign(PPersistent(Params^[1])^);
end;

//constructor Create;
procedure TGraphic_Init(const Params: PParamArray);cdecl;
begin
  PGraphic(Params^[0])^ := TGraphic.Create();
end;

//procedure Clear;
procedure TGraphic_Clear(const Params: PParamArray);cdecl;
begin
  PGraphic(Params^[0])^.Clear();
end;

//procedure LoadFromFile(const Filename: string);
procedure TGraphic_LoadFromFile(const Params: PParamArray);cdecl;
begin
  PGraphic(Params^[0])^.LoadFromFile(PlpString(Params^[1])^);
end;

//procedure SaveToFile(const Filename: string);
procedure TGraphic_SaveToFile(const Params: PParamArray);cdecl;
begin
  PGraphic(Params^[0])^.SaveToFile(PlpString(Params^[1])^);
end;

//Read: property Empty: Boolean read Empty;
procedure TGraphic_Empty_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PGraphic(Params^[0])^.Empty;
end;

//Read: property Height: Integer read Height write Height;
procedure TGraphic_Height_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PGraphic(Params^[0])^.Height;
end;

//Write: property Height: Integer read Height write Height;
procedure TGraphic_Height_Write(const Params: PParamArray);cdecl;
begin
  PGraphic(Params^[0])^.Height := PInteger(Params^[1])^;
end;

//Read: property Modified: Boolean read Modified write Modified;
procedure TGraphic_Modified_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PGraphic(Params^[0])^.Modified;
end;

//Write: property Modified: Boolean read Modified write Modified;
procedure TGraphic_Modified_Write(const Params: PParamArray);cdecl;
begin
  PGraphic(Params^[0])^.Modified := PBoolean(Params^[1])^;
end;

//Read: property OnChange: TNotifyEvent read FOnChange write FOnChange;
procedure TGraphic_OnChange_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PNotifyEvent(Result)^ := PGraphic(Params^[0])^.OnChange;
end;

//Write: property OnChange: TNotifyEvent read FOnChange write FOnChange;
procedure TGraphic_OnChange_Write(const Params: PParamArray);cdecl;
begin
  PGraphic(Params^[0])^.OnChange := PNotifyEvent(Params^[1])^;
end;

//Read: property Palette: Integer read GetPalette write SetPalette;
procedure TGraphic_Palette_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PGraphic(Params^[0])^.Palette;
end;

//Write: property Palette: Integer read GetPalette write SetPalette;
procedure TGraphic_Palette_Write(const Params: PParamArray);cdecl;
begin
...
procedure TGraphic_PaletteModified_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TGraphic_PaletteModified_Write(const Params: PParamArray);cdecl;
begin
  PGraphic(Params^[0])^.PaletteModified := PBoolean(Params^[1])^;
end;

//Read: property Transparent: Boolean read Transparent write Transparent;
procedure TGraphic_Transparent_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PGraphic(Params^[0])^.Transparent;
end;

//Write: property Transparent: Boolean read Transparent write Transparent;
procedure TGraphic_Transparent_Write(const Params: PParamArray);cdecl;
begin
  PGraphic(Params^[0])^.Transparent := PBoolean(Params^[1])^;
end;

//Read: property Width: Integer read Width write Width;
procedure TGraphic_Width_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PGraphic(Params^[0])^.Width;
end;

//Write: property Width: Integer read Width write Width;
procedure TGraphic_Width_Write(const Params: PParamArray);cdecl;
begin
  PGraphic(Params^[0])^.Width := PInteger(Params^[1])^;
end;

//procedure Free();
procedure TGraphic_Free(const Params: PParamArray);cdecl;
begin
  PGraphic(Params^[0])^.Free();
end;

procedure TGraphic_LoadFromClipboardFormat(const Params: PParamArray);cdecl;
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure TGraphic.LoadFromClipboardFormat(); constref;', @TGraphic_LoadFromClipboardFormat);
...
procedure TBitmap_TransparentColor_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TBitmap_TransparentColor_Write(const Params: PParamArray);cdecl;
begin
...
procedure TBitmap_TransparentMode_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TBitmap_TransparentMode_Write(const Params: PParamArray);cdecl;
begin
  PBitmap(Params^[0])^.TransparentMode := PTransparentMode(Params^[1])^;
end;

//procedure Free();
procedure TBitmap_Free(const Params: PParamArray);cdecl;
begin
  PBitmap(Params^[0])^.Free();
end;

procedure TBitmap_Transparent_Write(const Params: PParamArray);cdecl;
begin
  PBitmap(Params^[0])^.Transparent := PBoolean(Params^[1])^;
end;

procedure TBitmap_Transparent_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PBitmap(Params^[0])^.Transparent;
end;

procedure TBitmap_ToString(const Params: PParamArray; const Result: Pointer);cdecl;
var
  b: TBitmap;
  x, y, w, h: integer;
...
procedure TBitmap_LoadFromString(const Params: PParamArray);cdecl;
var
  x, y, w, h: integer;
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('function TBitmap.BitmapHandleAllocated(): boolean; constref;', @TBitmap_BitmapHandleAllocated);
    addGlobalFunc('function TBitmap.MaskHandleAllocated(): boolean; constref;', @TBitmap_MaskHandleAllocated);
    addGlobalFunc('function TBitmap.PaletteAllocated(): boolean; constref;', @TBitmap_PaletteAllocated);
    addGlobalFunc('procedure TBitmap.LoadFromStream(AStream: TStream); constref;', @TBitmap_LoadFromStream);
    addGlobalFunc('procedure TBitmap.LoadFromStream(AStream: TStream; ASize: Cardinal);constref; overload;', @TBitmap_LoadFromStreamEx);
    addGlobalFunc('procedure TBitmap.SaveToStream(AStream: TStream); constref;', @TBitmap_SaveToStream);
    addGlobalFunc('procedure TBitmap.GetSize(var AWidth, AHeight: Integer); constref;', @TBitmap_GetSize);
    addGlobalFunc('procedure TBitmap.Mask(ATransparentColor: TColor); constref;', @TBitmap_Mask);
...
{TPicture}
//constructor Create;
procedure TPicture_Init(const Params: PParamArray);cdecl;
begin
  PPicture(Params^[0])^ := TPicture.Create();
end;

//procedure Clear;
procedure TPicture_Clear(const Params: PParamArray);cdecl;
begin
  PPicture(Params^[0])^.Clear();
end;

//procedure LoadFromFile(const Filename: string);
procedure TPicture_LoadFromFile(const Params: PParamArray);cdecl;
begin
  PPicture(Params^[0])^.LoadFromFile(PlpString(Params^[1])^);
end;

//procedure LoadFromStream(Stream: TStream);
procedure TPicture_LoadFromStream(const Params: PParamArray);cdecl;
begin
  PPicture(Params^[0])^.LoadFromStream(PStream(Params^[1])^);
end;

//procedure LoadFromStreamWithFileExt(Stream: TStream; const FileExt: string);
procedure TPicture_LoadFromStreamWithFileExt(const Params: PParamArray);cdecl;
begin
...
procedure TPicture_SaveToFile(const Params: PParamArray);cdecl;
begin
  PPicture(Params^[0])^.SaveToFile(PlpString(Params^[1])^, PlpString(Params^[2])^);
end;

//procedure SaveToStream(Stream: TStream);
procedure TPicture_SaveToStream(const Params: PParamArray);cdecl;
begin
  PPicture(Params^[0])^.SaveToStream(PStream(Params^[1])^);
end;

//procedure SaveToStreamWithFileExt(Stream: TStream; const FileExt: string);
procedure TPicture_SaveToStreamWithFileExt(const Params: PParamArray);cdecl;
begin
...
procedure TPicture_Bitmap_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBitmap(Result)^ := PPicture(Params^[0])^.Bitmap;
end;

//Write: property Bitmap: TBitmap read Bitmap write Bitmap;
procedure TPicture_Bitmap_Write(const Params: PParamArray);cdecl;
begin
  PPicture(Params^[0])^.Bitmap := PBitmap(Params^[1])^;
end;

//Read: property Graphic: TGraphic read FGraphic write SetGraphic;
procedure TPicture_Graphic_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PGraphic(Result)^ := PPicture(Params^[0])^.Graphic;
end;

//Write: property Graphic: TGraphic read FGraphic write SetGraphic;
procedure TPicture_Graphic_Write(const Params: PParamArray);cdecl;
begin
  PPicture(Params^[0])^.Graphic := PGraphic(Params^[1])^;
end;

//Read: property Height: Integer read Height;
procedure TPicture_Height_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PPicture(Params^[0])^.Height;
end;

//Read: property Width: Integer read Width;
procedure TPicture_Width_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PPicture(Params^[0])^.Width;
end;

//Read: property OnChange: TNotifyEvent read FOnChange write FOnChange;
procedure TPicture_OnChange_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PNotifyEvent(Result)^ := PPicture(Params^[0])^.OnChange;
end;

//Write: property OnChange: TNotifyEvent read FOnChange write FOnChange;
procedure TPicture_OnChange_Write(const Params: PParamArray);cdecl;
begin
  PPicture(Params^[0])^.OnChange := PNotifyEvent(Params^[1])^;
end;

//procedure Free();
procedure TPicture_Free(const Params: PParamArray);cdecl;
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure TPicture.LoadFromStreamWithFileExt(Stream: TStream; const FileExt: string); constref;', @TPicture_LoadFromStreamWithFileExt);
    addGlobalFunc('procedure TPicture.SaveToFile(const Filename: string; const FileExt: string); constref;', @TPicture_SaveToFile);
    addGlobalFunc('procedure TPicture.SaveToStream(Stream: TStream); constref;', @TPicture_SaveToStream);
    addGlobalFunc('procedure TPicture.SaveToStreamWithFileExt(Stream: TStream; const FileExt: string); constref;', @TPicture_SaveToStreamWithFileExt);
